...
Les 3 premiers exercices seront des oeuvres purement numériques qui doivent être montrées, expliquées et ajustées live, en classe. Elles seront essentiellement visuelles et peuvent inclure des éléments sonores.

Le format de l'oeuvre présentée pour le vernissage est libre. L'oeuvre peut être purement numérique et projetée, ou elle peut être physicalisée, par exemple avec un [traçeur](https://www.generativehut.com/) ou avec des [LED](https://en.wikipedia.org/wiki/LED_art).
...
# Semaine 1 (7 janvier)
 ...
 - inspirations:
   ...
   - [The Art of Algorithms](https://www.rightclicksave.com/article/infinite-images-the-art-of-algorithms-toledo-museum-of-art-generative-art), 2025

# Semaine 2 (12, 14 janvier)
...
# Semaine 9 (09, 11 mars)
- data art
- présentations d'étudiants

# Semaine 10 (16, 18 mars)
