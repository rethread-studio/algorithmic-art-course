...
(() => {
    ...
    function createParticlesFromAnchors() {
        ...
        if (config.forceInsideSectionOnInit) {            
            ...
            // for (let i = 1; i < 4; i++) {
            //     const pos = i * (O_sectionwidth / 4);
            //     addAnchorPoint(pos, config.safeMargin);
            //     addAnchorPoint(pos, O_sectionheight - config.safeMargin);
            // }
            
            // for (let i = 1; i < 4; i++) {
            //     const pos = i * (O_sectionheight / 4);
            //     addAnchorPoint(config.safeMargin, pos);
            //     addAnchorPoint(O_sectionwidth - config.safeMargin, pos);
            // }
